...
module Facter
  module Operatingsystem
    ...
    class Base
      ...
      def get_operatingsystempatchrelease
        if operatingsystemrelease = get_operatingsystemrelease
          if (releasepatch = operatingsystemrelease.split(".")[2])
            releasepatch.to_i
          end
        end
      end
      ...
      def get_operatingsystemrelease_hash
        ...
        if releasepatch = get_operatingsystempatchrelease
          release_hash["patch"] = releasepatch
        end
    ...
    class CumulusLinux < Linux
      ...
      def get_operatingsystemmajrelease
        if operatingsystemrelease = get_operatingsystemrelease
          operatingsystemrelease.split(".").first.to_i
        end
      end
    end
