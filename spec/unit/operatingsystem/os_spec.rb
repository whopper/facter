...
describe Facter::Operatingsystem::Base do
  ...
  describe "Operatingsystempatchrelease" do
    it "should base patch release on release fact if available" do
      subject.expects(:get_operatingsystemrelease).returns("1.2.3")
      operatingsystemmajrelease = subject.get_operatingsystempatchrelease
      expect(operatingsystemmajrelease).to eq 3
    end
  ...
  describe "Operatingsystemrelease hash" do
    it "should return a hash of release values" do
      ...
      expect(release_hash).to eq({"major" => 1, "minor" => 2, "patch" => 3, "full" => "1.2.3" })
    end
  end
